...
export class HelpPage implements OnInit {
  ...
  readonly questions = [
    ...
    },
    {
      ...
      answer:
        ...
        and those items are ranked with their total amounts on descending order using Quick Sort Algorithm.</p>`
    },
    {
      question: 'How does the bill reminder feature work?',
      answer:
        `<p>The bill reminder feature allows you to set reminders for upcoming bills that you need to pay. You can set the due date for the bill, and the reminder will automatically notify you 3, 2, and 1 day before the due date.</p>`
    },
    {
  ...
  parseMail() {
    ...
    this.hrefMail = `mailto:ctquia-eo.ccit@unp.edu.ph?subject=${subject}&body=${desc}`;
